...
~25k stars on the core as of September 2026 (the homepage's old MemGPT counter undersells it), $10M Felicis-led seed at the 2024 rename. Hosted pricing, as of September 2026 from docs.letta.com: a $0 free tier on your own API keys, Pro at $20/month, Teams Pro at $20 per seat/month, and a $20/month developer API plan metered at $0.10 per active agent per month. Against the memory-layer alternatives — [Mem0](/tools/mem0)'s drop-in API, [Zep](/tools/zep)'s temporal graphs — the trade is adopt-the-runtime versus add-the-layer: [Mem0 vs Zep vs Letta](/guides/comparisons/mem0-vs-zep-vs-letta) draws it out.
