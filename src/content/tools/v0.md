...
featured: true
related: ["tool:lovable", "tool:bolt", "tool:cursor"]
...
faq:
  ...
  - q: "Is v0 free?"
    a: "Plans, as of September 2026 from v0.app/pricing: Free is $0/month with $5 of included monthly credits and a 7-message-per-day limit, including deploys, visual editing, and GitHub sync. Plus is $30/user/month with $30 of included monthly credits plus $2 of free daily credits on login; Business is $100/user/month with the same credits plus training opt-out by default; Enterprise is custom with SAML SSO, role-based access control, and SLAs. Usage is metered with token-based, model-priced credits, so cost varies with model choice and request complexity."
...
v0 is available in the browser and via an iOS app. Pricing is freemium, as of September 2026 from v0.app/pricing: the Free plan includes $5 of monthly credits with a 7-message-per-day limit, plus deploys, visual editing, and GitHub sync; **Plus** ($30/user/month) adds $30 of monthly credits per user, $2 of free daily credits on login, shared credit purchasing, and centralized billing; **Business** ($100/user/month) keeps the same per-user credits but adds training opt-out by default for data privacy; **Enterprise** (custom) adds SAML SSO, role-based access control, priority access, and SLAs. Since May 2025, v0 has metered usage with token-based, model-priced credits, so cost per generation varies with the model chosen and the complexity of the request. It is a hosted Vercel product, not open source, and is most at home in the Next.js and Vercel ecosystem.
