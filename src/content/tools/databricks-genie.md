...
faq:
  ...
  - q: "Does Genie cost extra?"
    a: "It is consumption-based rather than a separate license. Databricks documents that Genie One and Genie Agents usage by users is free until January 31, 2027 and pay-as-you-go afterwards, with service principal traffic billed throughout; Genie Code moved to pay-as-you-go on July 8, 2026 with 150 free DBUs per user per month. The compute the queries run on is billed separately in every case, and your data has to be managed in Unity Catalog."
---
...
Genie is part of the Databricks platform rather than a separate purchase, and it is billed by consumption. As of September 2026 Databricks documents that Genie One and Genie Agents usage by users is free until January 31, 2027 and pay-as-you-go after that, while service principal traffic is billed the whole time; Genie Code moved to pay-as-you-go on July 8, 2026, with 150 free DBUs per user per month and overage on the Serverless Real-Time Inference SKU. The compute your queries run on is billed separately either way. Your data must be managed in Unity Catalog, and the feature set assumes Pro or Serverless SQL compute.
